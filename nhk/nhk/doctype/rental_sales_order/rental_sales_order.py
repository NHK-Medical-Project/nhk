...
class RentalSalesOrder(SellingController):
	...
	def __init__(self, *args, **kwargs):
		super(RentalSalesOrder, self).__init__(*args, **kwargs)
	...
	def validate_warehouse(self):
		super(RentalSalesOrder, self).validate_warehouse()
	...
	def validate_with_previous_doc(self):
		super(RentalSalesOrder, self).validate_with_previous_doc(
			{
