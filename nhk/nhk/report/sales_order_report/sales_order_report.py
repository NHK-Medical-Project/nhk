...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Referrer", "fieldname": "custom_referrer", "fieldtype": "Link", "options": "Referrer", "width": 100},
        {"label": "Referrer Name", "fieldname": "custom_referrer_name", "fieldtype": "Data", "width": 100},
        {"label": "Referrer Hospital", "fieldname": "custom_referrer_hospital", "fieldtype": "Link", "options": "Hospital", "width": 80},

        {"label": "Referrer Commission Amount", "fieldname": "custom_referrer_commission_amount", "fieldtype": "Currency", "width": 80},
        {"label": "Referrer Commission Status", "fieldname": "custom_referrer_commission_status", "fieldtype": "Data", "width": 100},
        {"label": "Sales Person", "fieldname": "sales_person", "fieldtype": "Link", "options": "Sales Person", "width": 100},
        ...
        {"label": "SD Received", "fieldname": "sd_received", "fieldtype": "Currency", "width": 100},
        {"label": "SD Refunded", "fieldname": "sd_refunded", "fieldtype": "Currency", "width": 100},
        {"label": "SD Adjusted", "fieldname": "sd_adjusted", "fieldtype": "Currency", "width": 100},
    ...
    for order in sales_orders:
        ...
        row = {
            ...
            "sd_adjusted": order.adjustment_amount,
            "customer_mobile_no": order.customer_mobile_no,
            "status": order.status,
            "sd_received": order.paid_security_deposite_amount,
            "sd_refunded": order.security_deposit_amount_return_to_client,
            "sd_refunded": order.security_deposit_amount_return_to_client,
